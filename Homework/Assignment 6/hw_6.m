...
dC1 = @(t,c1,c2,c3) -k1*c1 +k2*c2*c3;
dC2 = @(t,c1,c2,c3) k1*c1 -k2*c2*c3 - 2*k3*c2^2;
dC3 = @(t,c1,c2,c3) 2*k3*c2^2;

dCdt = @(t,c1,c2,c3) dC1 + dC2 + dC3 -1;
...
[t_stiff, C_stiff] = ode23s(, tspan, C0, opt);
